...
3. **Yahoo API application.** Will submitted 2026-09-15. If approved, `nfl/yahoo_api.py` is ready; swap `weekly/am/pm` to it for rosters and actuals, keep `yahoo_web.py` for projections (the API has none).
